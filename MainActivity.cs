...
namespace XAExpandableListView
{
    ...
    public class MainActivity : AppCompatActivity
    {
        ...
        private void LoadData()
        {
            ...
            listHeaderData.Add("HID 1");
            listHeaderData.Add("HID 2");
            listHeaderData.Add("HID 3");
            ...
            {
                groupData = new List<ExpandableChildModel>();
                groupData.Add(new ExpandableChildModel() { Name = i+"Child 11"});
                groupData.Add(new ExpandableChildModel() { Name = i + "Child 22" });
                groupData.Add(new ExpandableChildModel() { Name = i + "Child 33" });
